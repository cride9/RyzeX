...
namespace ImGui
{
	...
	bool					ButtonCenteredOnLine(const char* label, float alignment = 0.5f, bool selected = true);
	IMGUI_API bool          Button(const char* label, const ImVec2& size = ImVec2(0, 0), bool selected = false);   // button

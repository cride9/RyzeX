...
namespace ImGui
{
    ...
    IMGUI_API bool          Button(const char* label, const ImVec2& size = ImVec2(0, 0), bool bSelected = false, bool bFrame = true);   // button
    ...
    IMGUI_API bool          ColorEdit4(const char* label, float col[4], bool bSameRow = false, ImGuiColorEditFlags flags = 0);

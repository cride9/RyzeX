...
//		Document()
//		{
//			BOMS[UTF8] = { (char*)"\xEF\xBB\xBF", 3 };
//			BOMS[UTF16_LE] = { (char*)"\xFF\xFE", 2 };
//			BOMS[UTF16_BE] = { (char*)"\xFE\xFF", 2 };
//			BOMS[UTF32_LE] = { (char*)"\xFF\xFE\x00\x00", 4 };
//			BOMS[UTF32_BE] = { (char*)"\x00\x00\xFE\xFF", 4 };
//		}
//
//		~Document()
//		{
...
//			char name[256];
//			V_UCS2ToUTF8(wide_name, name, sizeof(name));
//			c_paintkits::sticker_kits.push_back({ sticker_kit->id, name });
//		}
...
//		return 6;
//
//	//std::unordered_map<std::string, std::set<std::string>> config.weaponSkins;
//	//std::unordered_map<std::string, skinInfo> config.skinMap;
...
//
//					auto skinInfo = &g_skins.skin_map[paint_kit_name];
//

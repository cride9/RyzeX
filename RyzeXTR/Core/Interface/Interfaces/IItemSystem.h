...
//};
//
//class EconItemDefinition_t
//{
//public:
//
//	__forceinline const CUtlVector<ItemListEntry>& getLootListContents()
//	{
//		return util::GetVFunc< const CUtlVector<ItemListEntry>&(__thiscall*)(void*) >(this, 1)(this);
//	}
//
//	__forceinline int getItemCount()
//	{
//		return util::GetVFunc< int (__thiscall*)(void*) >(this, 4)(this);
//	}
//
//	__forceinline const char* GetPlayerDisplayModel()
//	{
//		return util::GetVFunc< const char* (__thiscall*)(void*) >(this, 6)(this);
//	}
//
//	__forceinline const char* GetWorldDisplayModel()
//	{
//		return util::GetVFunc< const char* (__thiscall*)(void*) >(this, 7)(this);
//	}
//
//	__forceinline std::uint8_t GetQuality() noexcept
//	{
//		return *reinterpret_cast<std::uint8_t*>(std::uintptr_t(this) + 0x2B);
//	}
//
//	__forceinline int GetItemType() noexcept
//	{
//		return *reinterpret_cast<int*>(std::uintptr_t(this) + 0x130);
//	}
//
//	__forceinline const char* GetDefinitionName() noexcept
//	{
...
//{
//public:
//	__forceinline EconItemDefinition_t* GetItemDefinitionInterface(int id)
//	{
//		return util::GetVFunc< EconItemDefinition_t * (__thiscall*)(void*, int) >(this, 4)(this, id);
//	}
//
//	__forceinline int getItemSetCount()
//	{
//		return util::GetVFunc< int(__thiscall*)(void*) >(this, 28)(this);
//	}
//
//	__forceinline EconItemSetDefinition* getItemSet(int index)
//	{
//		return util::GetVFunc< EconItemSetDefinition * (__thiscall*)(void*, int) >(this, 29)(this, index);
//	}
//
//	__forceinline EconItemDefinition_t* getLootList(int index)
//	{
//		return util::GetVFunc< EconItemDefinition_t * (__thiscall*)(void*, int) >(this, 32)(this, index);
//	}
//
//	__forceinline int getLootListCount()
//	{
//		return util::GetVFunc< int(__thiscall*)(void*) >(this, 34)(this);
//	}
//
//	__forceinline auto GetItemDefinitionInterface(short id) noexcept
//	{

...
public:
	...
	{
		return util::CallVFunc<EImageFormat>(this, 36);
	}

	IMaterial* CreateMaterial(const char* szName, CKeyValues* pKeyValues)
	{
		return util::CallVFunc<IMaterial*>(this, 83, szName, pKeyValues);
	}
	...
	{
		return util::CallVFunc<IMaterial*>(this, 84, szMaterialName, szTextureGroupName, bComplain, pComplainPrefix);
	}

	MaterialHandle_t FirstMaterial()
	{
		return util::CallVFunc<MaterialHandle_t>(this, 86);
	}

	MaterialHandle_t NextMaterial(MaterialHandle_t hMaterial)
	{
		return util::CallVFunc<MaterialHandle_t>(this, 87, hMaterial);
	}

	MaterialHandle_t InvalidMaterial()
	{
		return util::CallVFunc<MaterialHandle_t>(this, 88);
	}

	IMaterial* GetMaterial(MaterialHandle_t hMaterial)
	{
		return util::CallVFunc<IMaterial*>(this, 89, hMaterial);
	}

	int	GetNumMaterials()
	{
		return util::CallVFunc<int>(this, 90);
	}
	...
	{
		return util::CallVFunc<ITexture*>(this, 91, szTextureName, szTextureGroupName, bComplain, nAdditionalCreationFlags);
	}

	void BeginRenderTargetAllocation()
	{
		util::CallVFunc<void>(this, 94);
	}

	void EndRenderTargetAllocation()
	{
		util::CallVFunc<void>(this, 95);
	}
	...
	{
		return util::CallVFunc<ITexture*>(this, 96, iWidth, iHeight, sizeMode, format, depth);
	}
	...
	{
		return util::CallVFunc<ITexture*>(this, 97, szName, iWidth, iHeight, sizeMode, format, depth, fTextureFlags, fRenderTargetFlags);
	}
	...
	{
		return util::CallVFunc<ITexture*>(this, 98, szName, iWidth, iHeight, sizeMode, format, depth, bClampTexCoords, bAutoMipMap);
	}
	...
	{
		return util::CallVFunc<ITexture*>(this, 99, szName, iWidth, iHeight, sizeMode, format, depth, fTextureFlags, fRenderTargetFlags);
	}

	IMatRenderContext* GetRenderContext()
	{
		return util::CallVFunc<IMatRenderContext*>(this, 115);
	}

	void FinishRenderTargetAllocation()
	{
		util::CallVFunc<void>(this, 136);
	}
